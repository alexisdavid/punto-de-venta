<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar contactos y/o proveedores</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php
          ...
          $proveedor = ControladorCuentas::ctrMostrarProveedor($item, $valor);
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoProveedor" placeholder="Nombre Proveedor" required>
        ...
        <?php
          ...
          $crearProveedor = new ControladorCuentas();
...
<div id="modalEditarProveedor" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control input-lg" name="editarEmail" id="editarEmail" placeholder="editarEmail" required>
     ...
     <?php
          ...
          $editarProveedor = new ControladorCuentas();
 ...
 <?php
  ...
  $borrarProducto = new ControladorCuentas();
  $borrarProducto -> ctrBorrarProveedor();
